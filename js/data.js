class Athlete {
    constructor(name, dob, headline, subhead, img, bio){
        this.name =name;
        this.dob = dob;
...
const usain = new Athlete(
    "Usain Bolt", "08/21/1986", "Bolt blazes to 100m <br> World Championships glory!",
    "World record holder edges out man-in-form Gatlin to grab gold; Ennis-Hill regains heptathlon title.",
    "img/usain-bolt.jpg",
    `Jamaican Usain Bolt won the 100m title at the world athletics championships
...
const shelly = new Athlete (
    "Shelly-Ann Fraser-Pryce",
    "12/27/1986",
    "SHELLY-ANN FRASER-PRYCE, <br />THE GREATEST FEMALE SPRINTER OF ALL TIME?",
    "Two consecutive Olympic titles in the 100m, four world titles in the same distance, six Olympic medals in total, eleven World Championship medals overall, nine of which are gold",
    "img/shelly-ann.png",
    `Carrying her two-year-old son, Zyon, in her arms and with her hair dyed in the colours of the
...
const michael = new Athlete (
    "Michael Phelps",
    "06/30/1985",

    "Watch 19-year-old Hungarian swimmer shatter Michael Phelps' world record in 200 butterfly",
    "The Real MerMan",

    "img/michael-phelps.jpg",

    `Michael Phelps owned the world record in the 200-meter butterfly for 18 straight years. And now, 
